                                    ...
                                    <div class="card border-0 rounded-0">
                                        <div class="card-body">
                                            <fieldset>
                                                ...
                                                <div class="form-group">
                                                    <div class="custom-check-wrapper">
                                                        <input type="checkbox" name="solar-priority"
                                                            id="energy-saving-mode" class="check_rej">
                                                ...
                                                <div class="form-group">
                                                    <div class="custom-check-wrapper">
                                                        <input type="checkbox" name="solar-priority" id="grid-utility"
                                                            class="check_rej">
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="form-group">
                                                    <div class="custom-check-wrapper">
                                                        <input type="checkbox" name="user-installation-choice"
                                                            id="off-grid" class="check_rej">
                                                ...
                                                <div class="form-group">
                                                    <div class="custom-check-wrapper">
                                                        <input type="checkbox" name="user-installation-choice"
                                                            id="grid-support" class="check_rej">
                                        ...
                                        <div class="card-body">
                                            <div>
                                                <span class="firstPrevBtn btn btn-sm py-2 px-0">
                                                    <svg width="27" height="29" viewBox="0 0 31 33" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <path
                                                            d="M15.4997 0.876957C6.94514 0.87102 0.00844755 7.8687 0 16.4925C0.00844755 25.131 6.94514 32.1281 15.4997 32.125C24.0574 32.1281 30.9934 25.131 31 16.4925C30.9937 7.8687 24.0574 0.87102 15.4997 0.876957ZM15.4997 28.5243C8.9178 28.5243 3.58082 23.1418 3.58645 16.4925C3.57988 9.85794 8.9178 4.4736 15.4997 4.47704C22.0847 4.47391 27.4223 9.85826 27.4298 16.4925C27.4223 23.1418 22.0847 28.5243 15.4997 28.5243Z"
                                                            fill="#EA4B4B" />
                                                        <path
                                                            d="M22.3924 12.5845L19.421 9.61719L15.4998 13.5338L11.5783 9.61719L8.60693 12.5845L12.5297 16.5033L8.60693 20.4177L11.5783 23.3851L15.4998 19.4684L19.421 23.3851L22.3924 20.4177L18.4709 16.5033L22.3924 12.5845Z"
                                                            fill="#EA4B4B" />
                                                    </svg>
                                                </span>
                                            </div>
                                    ...
                                    <div class="card rounded-0 step-footer">
                                        <div class="card-body">
                                            <div class="d-flex align-items-center justify-content-between">
                                                <span class="btn btn-lg rounded-0 btn-white firstNextBtn">ADD ANOTHER
                                                    APPLIANCE</span>
                                                <span
                                                    class="btn btn-lg rounded-0 btn-success firstNextBtn">CALCULATE</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
