        ...
        <div class="container">
            ...
            <ul class="services-list my-0 p-0 list-style-none row">
                <li class="item col-12 col-sm-6 text-center">
                    ...
                    <h5 class="title">Energy Audit</h5>
                    <p class="body">Our energy audit involves a comprehensive analysis of a prospective client load
                        to understand the nature of the solar Photovoltaic (PV) system and the right
                        battery capacity that will be suited for their needs. This involves a careful
                        consideration of the electrical power rating of the devices and the expected
                        duration of use on the inverter system. We deploy where necessary, our energy
                        logging tools to capture typical client energy requirement in real time. This
                ...
                <li class="item col-12 col-sm-6 text-center">
                    ...
                    <h5 class="title">System Simulation</h5>
                    <p class="body">Using tools that simulate the real-world operation of solar PV systems, we put a
                        designed system to test. This helps us identify areas for improvement of the
                ...
                <li class="item col-12 col-sm-6 text-center">
                    ...
                    <h5 class="title">System Installation</h5>
                    <p class="body">From our wide range of products and with offerings from our partners, we select
                        the right products for your system that will give the results envisioned. Our
                ...
                <li class="item col-12 col-sm-6 text-center">
                    ...
                    <h5 class="title">Product Sales</h5>
                ...
                <li class="item col-12 col-sm-6 text-center">
                    ...
                    <h5 class="title">Product Delivery</h5>
                    <p class="body">From our wide range of products and with offerings from our partners, we select
                        the right products for your system that will give the results envisioned. Our
                        installations follow the right practices to ensure safe system operation and
                        prolonged system life.</p>
